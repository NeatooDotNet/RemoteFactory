...
layout: default
title: "v0.2.0"
description: "Release notes for Neatoo RemoteFactory v0.2.0"
parent: Release Notes
nav_order: 4
---

# v0.2.0 - Ordinal Serialization

**Release Date:** 2026-01-01
**NuGet:** [Neatoo.RemoteFactory 0.2.0](https://nuget.org/packages/Neatoo.RemoteFactory/0.2.0)
...
For the best experience, update both client and server to v0.2.0. The ordinal format will be used automatically.
