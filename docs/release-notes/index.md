...
|---------|------|------------|
| [v0.21.0](v0.21.0.md) | 2026-03-08 | Can* guard derived from auth class (breaking), fixes client-side auth check bug |
...
- [v0.21.0](v0.21.0.md) - 2026-03-08 - Can* guard derived from auth class
