...
layout: default
title: "v0.9.0"
description: "Release notes for Neatoo RemoteFactory v0.9.0"
parent: Release Notes
nav_order: 2
---

# v0.9.0 - Client-Server Code Separation with FactoryMode

**Release Date:** 2026-01-13
**NuGet:** [Neatoo.RemoteFactory 0.9.0](https://nuget.org/packages/Neatoo.RemoteFactory/0.9.0)
