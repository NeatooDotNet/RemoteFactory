...
Generated on `[Factory]` types to support compact ordinal serialization.
...
**Purpose:**
- Enables efficient serialization without reflection
- Returns property values in deterministic order (alphabetical, base class first)
- Generated by the source generator for all `[Factory]` types

**Generated Implementation:**

```csharp
// Generated for [Factory] types
partial class PersonModel : IOrdinalSerializable
{
...
### IOrdinalSerializationMetadata<T>

Generated metadata interface with static abstract members for deserialization.
...
**Purpose:**
- Provides property names for debugging and error messages
- Enables deserialization from ordinal arrays without reflection
- Requires .NET 7+ (static abstract members)

**Generated Implementation:**

```csharp
// Generated for [Factory] types
partial class PersonModel : IOrdinalSerializationMetadata<PersonModel>
{
    public static string[] PropertyNames => new[] { "Active", "Age", "Name" };

    public static PersonModel FromOrdinalArray(object?[] values)
    {
...
| `IOrdinalSerializable` | Ordinal serialization support | Generated on `[Factory]` types |
| `IOrdinalSerializationMetadata<T>` | Ordinal deserialization metadata | Generated on `[Factory]` types |
