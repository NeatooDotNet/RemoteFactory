...
*/
internal sealed partial class PersonModelServer
{
    ...
    {
        personEntity.FirstName = this.FirstName ?? throw new NullReferenceException("Person.DomainModel.Server.PersonModelServer.FirstName");
        personEntity.LastName = this.LastName ?? throw new NullReferenceException("Person.DomainModel.Server.PersonModelServer.LastName");
