...
public delegate Task<RemoteResponseDto> HandleRemoteDelegateRequest(RemoteDelegateRequestDto portalRequest);
...
public static class LocalServer
{
   ...
   public static HandleRemoteDelegateRequest HandlePortalRequest(IServiceProvider serviceProvider)
	{
		return async (RemoteDelegateRequestDto portalRequest) =>
		{
