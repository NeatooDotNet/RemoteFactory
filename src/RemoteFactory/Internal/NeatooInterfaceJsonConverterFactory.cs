...
public class NeatooInterfaceJsonConverterFactory : NeatooJsonConverterFactory
{
	private IServiceProvider scope;
	private readonly IServiceAssemblies serviceAssemblies;

	public NeatooInterfaceJsonConverterFactory(IServiceProvider scope, IServiceAssemblies serviceAssemblies)
	{
		this.scope = scope;
