    ...
    internal class InterfaceAuthorizeTestObjFactory : IInterfaceAuthorizeTestObjFactory
    {
        ...
        public static void FactoryServiceRegistrar(IServiceCollection services, NeatooFactory remoteLocal)
        {
            ...
            if (remoteLocal == NeatooFactory.Server)
            {
                ...
                {
                    var factory = cc.GetRequiredService<InterfaceAuthorizeTestObjFactory>();
                    return (bool hasAccess, CancellationToken cancellationToken = default) => factory.CanHasAspAccess(hasAccess, cancellationToken);
                });
                services.AddScoped<CanNoAspAccessDelegate>(cc =>
                {
                    var factory = cc.GetRequiredService<InterfaceAuthorizeTestObjFactory>();
                    return (bool hasAccess, CancellationToken cancellationToken = default) => factory.CanNoAspAccess(hasAccess, cancellationToken);
                });
            }
        }
    }
