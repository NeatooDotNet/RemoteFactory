...
///
/// The test pattern uses Theory/MemberData to run the same test against
/// both the client container (which goes through serialization) and the
/// local container (which executes directly without serialization).
/// </summary>
...
/// These tests verify full serialization round-trips for records.
/// </summary>
