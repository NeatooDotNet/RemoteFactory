...
namespace Neatoo.RemoteFactory.FactoryGeneratorTests.Factory
{
    ...
    internal class RemoteWriteAuthObjectFactory : FactoryBase<RemoteWriteAuthObject>, IRemoteWriteAuthObjectFactory
    {
        ...
        public virtual Task<Authorized<RemoteWriteAuthObject>> TrySaveVoid(RemoteWriteAuthObject target, int? param, CancellationToken cancellationToken = default)
        {
            return SaveVoidProperty(target, param, cancellationToken);
        }
        ...
        public virtual Task<Authorized<RemoteWriteAuthObject>> LocalSaveVoid(RemoteWriteAuthObject target, int? param, CancellationToken cancellationToken = default)
        {
            if (target.IsDeleted)
            {
                if (target.IsNew)
                {
                    return Task.FromResult(new Authorized<RemoteWriteAuthObject>());
                }
        ...
        public virtual Task<Authorized<RemoteWriteAuthObject>> TrySaveBool(RemoteWriteAuthObject target, int? param, CancellationToken cancellationToken = default)
        {
            return SaveBoolProperty(target, param, cancellationToken);
        }
        ...
        public virtual Task<Authorized<RemoteWriteAuthObject>> LocalSaveBool(RemoteWriteAuthObject target, int? param, CancellationToken cancellationToken = default)
        {
            if (target.IsDeleted)
            {
                if (target.IsNew)
