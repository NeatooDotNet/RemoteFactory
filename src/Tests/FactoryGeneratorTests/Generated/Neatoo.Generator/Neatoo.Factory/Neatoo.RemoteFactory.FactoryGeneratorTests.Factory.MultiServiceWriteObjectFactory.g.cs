...
namespace Neatoo.RemoteFactory.FactoryGeneratorTests.Factory
{
    ...
    internal class MultiServiceWriteObjectFactory : FactorySaveBase<MultiServiceWriteObject>, IFactorySave<MultiServiceWriteObject>, IMultiServiceWriteObjectFactory
    {
        ...
        public virtual Task<MultiServiceWriteObject> LocalSaveWithTwoServicesAsync(MultiServiceWriteObject target, CancellationToken cancellationToken = default)
        {
            if (target.IsDeleted)
            {
        ...
        public virtual Task<MultiServiceWriteObject?> LocalSaveWithTwoServicesBoolAsync(MultiServiceWriteObject target, CancellationToken cancellationToken = default)
        {
            if (target.IsDeleted)
            {
                throw new NotImplementedException();
