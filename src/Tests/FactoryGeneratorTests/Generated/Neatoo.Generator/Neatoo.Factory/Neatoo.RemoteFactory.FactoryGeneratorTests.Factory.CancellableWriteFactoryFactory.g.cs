...
namespace Neatoo.RemoteFactory.FactoryGeneratorTests.Factory
{
    ...
    internal class CancellableWriteFactoryFactory : FactorySaveBase<CancellableWriteFactory>, IFactorySave<CancellableWriteFactory>, ICancellableWriteFactoryFactory
    {
        ...
        public virtual Task<CancellableWriteFactory?> LocalSaveAsync(CancellableWriteFactory target, CancellationToken cancellationToken = default)
        {
            if (target.IsDeleted)
            {
                if (target.IsNew)
                {
                    return Task.FromResult(default(CancellableWriteFactory));
                }
