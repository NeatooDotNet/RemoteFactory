...
namespace Neatoo.RemoteFactory.FactoryGeneratorTests.InterfaceFactory
{
    ...
    internal class ExecuteMethodsFactory : IExecuteMethodsFactory
    {
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<bool>(typeof(BoolMethodDelegate), [a, b], default))!;
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<System.Collections.Generic.List<string>>(typeof(StringListMethodDelegate), [a, b], default))!;
        }
        ...
        public static void FactoryServiceRegistrar(IServiceCollection services, NeatooFactory remoteLocal)
        {
            ...
            if (remoteLocal == NeatooFactory.Server)
            {
                ...
                {
                    var factory = cc.GetRequiredService<ExecuteMethodsFactory>();
