    ...
    public static partial class ExecuteNullableWithService
    {
        ...
        internal static void FactoryServiceRegistrar(IServiceCollection services, NeatooFactory remoteLocal)
        {
            if (remoteLocal == NeatooFactory.Remote)
            {
                ...
                {
                    return (returnNull) => cc.GetRequiredService<IMakeRemoteDelegateRequest>().ForDelegateNullable<string?>(typeof(ExecuteNullableWithService.GetNullableResult), [returnNull]);
                });
                services.AddTransient<ExecuteNullableWithService.GetNullableResultRemote>(cc =>
                {
                    return (returnNull) => cc.GetRequiredService<IMakeRemoteDelegateRequest>().ForDelegateNullable<string?>(typeof(ExecuteNullableWithService.GetNullableResultRemote), [returnNull]);
                });
            }
