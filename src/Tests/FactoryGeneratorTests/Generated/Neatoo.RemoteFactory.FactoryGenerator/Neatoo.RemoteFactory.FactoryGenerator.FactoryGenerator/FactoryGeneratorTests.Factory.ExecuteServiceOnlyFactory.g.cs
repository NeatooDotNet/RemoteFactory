    ...
    public static partial class ExecuteServiceOnly
    {
        ...
        internal static void FactoryServiceRegistrar(IServiceCollection services, NeatooFactory remoteLocal)
        {
            if (remoteLocal == NeatooFactory.Remote)
            {
                ...
                {
                    return () => cc.GetRequiredService<IMakeRemoteDelegateRequest>().ForDelegate<int>(typeof(ExecuteServiceOnly.GetServiceValue), []);
                });
                services.AddTransient<ExecuteServiceOnly.GetCombinedServiceValues>(cc =>
                {
                    return () => cc.GetRequiredService<IMakeRemoteDelegateRequest>().ForDelegate<string>(typeof(ExecuteServiceOnly.GetCombinedServiceValues), []);
                });
                services.AddTransient<ExecuteServiceOnly.GetServiceValueRemote>(cc =>
                {
                    return () => cc.GetRequiredService<IMakeRemoteDelegateRequest>().ForDelegate<int>(typeof(ExecuteServiceOnly.GetServiceValueRemote), []);
                });
            }
