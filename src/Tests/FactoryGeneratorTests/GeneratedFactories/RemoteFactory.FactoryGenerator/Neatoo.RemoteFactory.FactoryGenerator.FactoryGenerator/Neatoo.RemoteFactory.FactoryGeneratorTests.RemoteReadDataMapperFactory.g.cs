...
using static Neatoo.RemoteFactory.FactoryGeneratorTests.RemoteReadTests;
...
namespace Neatoo.RemoteFactory.FactoryGeneratorTests
{
    ...
    internal class RemoteReadDataMapperFactory : FactoryBase, IRemoteReadDataMapperFactory
    {
        ...
        public RemoteReadDataMapperFactory(IServiceProvider serviceProvider, IMakeRemoteDelegateRequest remoteMethodDelegate)
        {
            this.ServiceProvider = serviceProvider;
        ...
        public Task<RemoteReadDataMapper> LocalCreateVoid()
        {
            ...
            return Task.FromResult(DoFactoryMethodCall<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateVoid()));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(CreateBoolDelegate), []))!;
        }

        public Task<RemoteReadDataMapper?> LocalCreateBool()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return Task.FromResult(DoFactoryMethodCallBool<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateBool()));
        }
        ...
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return DoFactoryMethodCallAsync<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateTask());
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(CreateTaskBoolDelegate), []))!;
        }

        public Task<RemoteReadDataMapper?> LocalCreateTaskBool()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return DoFactoryMethodCallBoolAsync<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateTaskBool());
        }
        ...
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return Task.FromResult(DoFactoryMethodCall<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateVoid(param)));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(CreateBool1Delegate), [param]))!;
        }

        public Task<RemoteReadDataMapper?> LocalCreateBool1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return Task.FromResult(DoFactoryMethodCallBool<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateBool(param)));
        }
        ...
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return DoFactoryMethodCallAsync<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateTask(param));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(CreateTaskBool1Delegate), [param]))!;
        }

        public Task<RemoteReadDataMapper?> LocalCreateTaskBool1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return DoFactoryMethodCallBoolAsync<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateTaskBool(param));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(CreateTaskBoolFalseDelegate), [param]))!;
        }

        public Task<RemoteReadDataMapper?> LocalCreateTaskBoolFalse(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return DoFactoryMethodCallBoolAsync<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateTaskBoolFalse(param));
        }
        ...
        public Task<RemoteReadDataMapper> LocalCreateVoidDep()
        {
            ...
            return Task.FromResult(DoFactoryMethodCall<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateVoidDep(service)));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(CreateBoolTrueDepDelegate), []))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalCreateBoolTrueDep()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return Task.FromResult(DoFactoryMethodCallBool<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateBoolTrueDep(service)));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(CreateBoolFalseDepDelegate), []))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalCreateBoolFalseDep()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return Task.FromResult(DoFactoryMethodCallBool<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateBoolFalseDep(service)));
        }
        ...
        public Task<RemoteReadDataMapper> LocalCreateTaskDep()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return DoFactoryMethodCallAsync<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateTaskDep(service));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(CreateTaskBoolDepDelegate), []))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalCreateTaskBoolDep()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return DoFactoryMethodCallBoolAsync<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateTaskBoolDep(service));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(CreateTaskBoolFalseDepDelegate), []))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalCreateTaskBoolFalseDep()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return DoFactoryMethodCallBoolAsync<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateTaskBoolFalseDep(service));
        }
        ...
        public Task<RemoteReadDataMapper> LocalCreateVoidDep1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return Task.FromResult(DoFactoryMethodCall<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateVoidDep(param, service)));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(CreateBoolTrueDep1Delegate), [param]))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalCreateBoolTrueDep1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return Task.FromResult(DoFactoryMethodCallBool<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateBoolTrueDep(param, service)));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(CreateBoolFalseDep1Delegate), [param]))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalCreateBoolFalseDep1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return Task.FromResult(DoFactoryMethodCallBool<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateBoolFalseDep(param, service)));
        }
        ...
        public Task<RemoteReadDataMapper> LocalCreateTaskDep1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return DoFactoryMethodCallAsync<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateTaskDep(param, service));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(CreateTaskBoolDep1Delegate), [param]))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalCreateTaskBoolDep1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return DoFactoryMethodCallBoolAsync<RemoteReadDataMapper>(target, FactoryOperation.Create, () => target.CreateTaskBoolDep(param, service));
        }
        ...
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return Task.FromResult(DoFactoryMethodCall<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchVoid()));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(FetchBoolDelegate), []))!;
        }

        public Task<RemoteReadDataMapper?> LocalFetchBool()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return Task.FromResult(DoFactoryMethodCallBool<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchBool()));
        }
        ...
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return DoFactoryMethodCallAsync<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchTask());
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(FetchTaskBoolDelegate), []))!;
        }

        public Task<RemoteReadDataMapper?> LocalFetchTaskBool()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return DoFactoryMethodCallBoolAsync<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchTaskBool());
        }
        ...
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return Task.FromResult(DoFactoryMethodCall<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchVoid(param)));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(FetchBool1Delegate), [param]))!;
        }

        public Task<RemoteReadDataMapper?> LocalFetchBool1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return Task.FromResult(DoFactoryMethodCallBool<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchBool(param)));
        }
        ...
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return DoFactoryMethodCallAsync<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchTask(param));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(FetchTaskBool1Delegate), [param]))!;
        }

        public Task<RemoteReadDataMapper?> LocalFetchTaskBool1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            return DoFactoryMethodCallBoolAsync<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchTaskBool(param));
        }
        ...
        public Task<RemoteReadDataMapper> LocalFetchVoidDep()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return Task.FromResult(DoFactoryMethodCall<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchVoidDep(service)));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(FetchBoolTrueDepDelegate), []))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalFetchBoolTrueDep()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return Task.FromResult(DoFactoryMethodCallBool<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchBoolTrueDep(service)));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(FetchBoolFalseDepDelegate), []))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalFetchBoolFalseDep()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return Task.FromResult(DoFactoryMethodCallBool<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchBoolFalseDep(service)));
        }
        ...
        public Task<RemoteReadDataMapper> LocalFetchTaskDep()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return DoFactoryMethodCallAsync<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchTaskDep(service));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(FetchTaskBoolDepDelegate), []))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalFetchTaskBoolDep()
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return DoFactoryMethodCallBoolAsync<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchTaskBoolDep(service));
        }
        ...
        public Task<RemoteReadDataMapper> LocalFetchVoidDep1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return Task.FromResult(DoFactoryMethodCall<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchVoidDep(param, service)));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(FetchBoolTrueDep1Delegate), [param]))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalFetchBoolTrueDep1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return Task.FromResult(DoFactoryMethodCallBool<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchBoolTrueDep(param, service)));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(FetchBoolFalseDep1Delegate), [param]))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalFetchBoolFalseDep1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return Task.FromResult(DoFactoryMethodCallBool<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchBoolFalseDep(param, service)));
        }
        ...
        public Task<RemoteReadDataMapper> LocalFetchTaskDep1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return DoFactoryMethodCallAsync<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchTaskDep(param, service));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(FetchTaskBoolDep1Delegate), [param]))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalFetchTaskBoolDep1(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return DoFactoryMethodCallBoolAsync<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchTaskBoolDep(param, service));
        }
        ...
        {
            return (await MakeRemoteDelegateRequest!.ForDelegate<RemoteReadDataMapper?>(typeof(FetchTaskBoolFalseDepDelegate), [param]))!;
        }
        ...
        public Task<RemoteReadDataMapper?> LocalFetchTaskBoolFalseDep(int? param)
        {
            var target = ServiceProvider.GetRequiredService<RemoteReadDataMapper>();
            var service = ServiceProvider.GetRequiredService<IService>();
            return DoFactoryMethodCallBoolAsync<RemoteReadDataMapper>(target, FactoryOperation.Fetch, () => target.FetchTaskBoolFalseDep(param, service));
        }
