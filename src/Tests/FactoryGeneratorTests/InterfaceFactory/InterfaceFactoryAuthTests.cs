...
public class InterfaceFactoryAuthTests : FactoryTestBase<IAuthorizedServiceFactory>
{
    private readonly IDeniedServiceFactory deniedServiceFactory;

    public InterfaceFactoryAuthTests() : base()
    {
        this.deniedServiceFactory = this.clientScope.ServiceProvider.GetRequiredService<IDeniedServiceFactory>();
    }
    ...
    public async Task InterfaceAuth_GetData_AuthorizationPasses()
    {
        ...
        var result = await this.factory.GetData(id);
    ...
    public async Task InterfaceAuth_ProcessData_AuthorizationPasses()
    {
        ...
        var result = await this.factory.ProcessData(id, "test data");
    ...
    public async Task InterfaceAuth_CheckStatus_AuthorizationPasses()
    {
        ...
        var result = await this.factory.CheckStatus(id);
    ...
    public async Task InterfaceAuth_GetItems_AuthorizationPasses()
    {
        ...
        var result = await this.factory.GetItems(id, 3);
    ...
    public async Task InterfaceAuth_ProcessData_AuthorizationFailsBool_ThrowsException()
    {
        ...
        await Assert.ThrowsAsync<NotAuthorizedException>(async () =>
        {
            await this.factory.ProcessData(id, "data");
        });
    }
    ...
    public async Task InterfaceAuth_CheckStatus_AuthorizationFailsBool_ThrowsException()
    {
        ...
        await Assert.ThrowsAsync<NotAuthorizedException>(async () =>
        {
            await this.factory.CheckStatus(id);
        });
    }
    ...
    public async Task InterfaceAuthDeny_GetDeniedData_AuthorizationAlwaysFails()
    {
        ...
        await Assert.ThrowsAsync<NotAuthorizedException>(async () =>
        {
            await this.deniedServiceFactory.GetDeniedData(id);
        });
    }
    ...
    public void InterfaceAuth_CanGetData_ReturnsTrue_WhenAuthorized()
    {
        ...
        var canAccess = this.factory.CanGetData(id);
    ...
    public void InterfaceAuth_CanProcessData_ReturnsTrue_WhenAuthorized()
    {
        ...
        var canAccess = this.factory.CanProcessData(id);
    ...
    public void InterfaceAuth_CanCheckStatus_ReturnsTrue_WhenAuthorized()
    {
        ...
        var canAccess = this.factory.CanCheckStatus(id);
    ...
    public void InterfaceAuth_CanGetItems_ReturnsTrue_WhenAuthorized()
    {
        ...
        var canAccess = this.factory.CanGetItems(id);
    ...
    public void InterfaceAuthDeny_CanGetDeniedData_ReturnsFalse_Always()
    {
        ...
        var canAccess = this.deniedServiceFactory.CanGetDeniedData();
    ...
    {
        var authorizedService = this.clientScope.ServiceProvider.GetRequiredService<IAuthorizedService>();
        var id = Guid.NewGuid();
    ...
    public async Task InterfaceAuth_MultipleMethods_AllAuthorize()
    {
        ...
        var data = await this.factory.GetData(id);
        var processed = await this.factory.ProcessData(id, "test");
        var status = await this.factory.CheckStatus(id);
        var items = await this.factory.GetItems(id, 2);
    ...
    public async Task InterfaceAuth_DifferentIdScenarios_EachAuthorizedIndependently()
    {
        ...
        var result1 = await this.factory.GetData(goodId);
        Assert.NotNull(result1);

        // Bad bool ID should fail
        await Assert.ThrowsAsync<NotAuthorizedException>(() => this.factory.GetData(badBoolId));

        // Bad string ID should fail with message
        var ex = await Assert.ThrowsAsync<NotAuthorizedException>(() => this.factory.GetData(badStringId));
        Assert.Contains("ExecuteDenied", ex.Message);

        // Good ID should still succeed after failures
        var result2 = await this.factory.GetData(goodId);
