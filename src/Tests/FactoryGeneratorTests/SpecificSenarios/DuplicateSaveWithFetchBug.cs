...
public class DuplicateSaveWithFetchBugTests : FactoryTestBase<IDuplicateSaveWithFetchBugFactory>
{
	/// <summary>
	...
	public async Task Save_WithCancellationToken_NoDuplicates()
	{
		...
		var saved = await this.factory.Save(obj, CancellationToken.None);
	...
	public async Task TrySave_WithCancellationToken_NoDuplicates()
	{
		...
		// This line would fail to compile with CS0111 if duplicates exist
		var result = await this.factory.TrySave(obj, CancellationToken.None);
	...
	public async Task Fetch_WithCancellationToken_Works()
	{
		...
		var fetched = await this.factory.Fetch(CancellationToken.None);
